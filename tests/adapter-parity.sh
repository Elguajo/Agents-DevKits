...
for phrase in 'canonical `skills/registry.yaml`' 'generated `.agents-devkits/ROUTING.md` snapshot' '`PROPOSE`' 'declared references on demand' 'Before adding code, dependencies' 'do not claim unavailable work'; do
